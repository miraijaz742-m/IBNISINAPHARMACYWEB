...
/** Editorial serif for hero + section titles — matte, premium finish */
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${sourceSerif.variable} ${notoUrdu.variable} overflow-x-hidden`}
    >
      <body className="font-sans antialiased text-ink overflow-x-hidden">
        ...
        <a
          ...
          className="fixed bottom-20 right-4 z-[55] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform active:scale-95 lg:hidden"
